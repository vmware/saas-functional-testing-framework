...
import static com.vmware.test.functional.saas.aws.local.jdbc.TestRedshiftDriver.DEFAULT_AWS_ACCESS_KEY;
import static com.vmware.test.functional.saas.aws.local.jdbc.TestRedshiftDriver.DEFAULT_AWS_REGION;
import static com.vmware.test.functional.saas.aws.local.jdbc.TestRedshiftDriver.DEFAULT_AWS_SECRET_ACCESS_KEY;
import static com.vmware.test.functional.saas.aws.local.jdbc.TestRedshiftDriver.S3_ENDPOINT_URL;
import static com.vmware.test.functional.saas.aws.local.jdbc.TestRedshiftDriver.QUERY_MAP_CLASS;
