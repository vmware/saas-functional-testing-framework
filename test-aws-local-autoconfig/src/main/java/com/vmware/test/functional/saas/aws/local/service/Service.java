...
import static com.vmware.test.functional.saas.aws.local.constants.LocalServiceConstants.Components.DYNAMODB_ENDPOINT;
import static com.vmware.test.functional.saas.aws.local.constants.LocalServiceConstants.Components.ELASTICSEARCH_ENDPOINT;
import static com.vmware.test.functional.saas.aws.local.constants.LocalServiceConstants.Components.KINESIS_ENDPOINT;
import static com.vmware.test.functional.saas.aws.local.constants.LocalServiceConstants.Components.KMS_ENDPOINT;
import static com.vmware.test.functional.saas.aws.local.constants.LocalServiceConstants.Components.LAMBDA_ENDPOINT;
import static com.vmware.test.functional.saas.aws.local.constants.LocalServiceConstants.Components.POSTGRES_ENDPOINT;
import static com.vmware.test.functional.saas.aws.local.constants.LocalServiceConstants.Components.PRESTO_ENDPOINT;
import static com.vmware.test.functional.saas.aws.local.constants.LocalServiceConstants.Components.REDIS_ENDPOINT;
import static com.vmware.test.functional.saas.aws.local.constants.LocalServiceConstants.Components.REDSHIFT_ENDPOINT;
import static com.vmware.test.functional.saas.aws.local.constants.LocalServiceConstants.Components.S3_ENDPOINT;
import static com.vmware.test.functional.saas.aws.local.constants.LocalServiceConstants.Components.SES_ENDPOINT;
import static com.vmware.test.functional.saas.aws.local.constants.LocalServiceConstants.Components.SNS_ENDPOINT;
import static com.vmware.test.functional.saas.aws.local.constants.LocalServiceConstants.Components.SQS_ENDPOINT;
