...
import com.aw.dpa.test.aws.local.constants.DockerContainerConstants;
import com.aw.dpa.test.aws.local.presto.PrestoContainerFactory;

import static com.aw.dpa.test.aws.local.service.CustomDockerContainer.DEFAULT_DOCKER_CONTAINER_STARTUP_TIMEOUT;
import static com.aw.dpa.test.aws.local.service.CustomDockerContainer.DEFAULT_WAIT_STRATEGY_TIMEOUT;
import static com.aw.dpa.test.aws.local.service.CustomDockerContainer.createDockerContainer;
