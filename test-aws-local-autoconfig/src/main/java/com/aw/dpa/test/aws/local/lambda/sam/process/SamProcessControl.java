...
package com.aw.dpa.test.aws.local.lambda.sam.process;
...
import com.aw.dpa.test.aws.local.lambda.sam.data.SamFunctionTemplateData;
import com.aw.dpa.test.aws.local.lambda.sam.data.SamTemplateGenerator;
import com.aw.dpa.test.environment.CalculateEnvironmentUtils;
