...
import com.aw.dpa.test.functional.aws.s3.S3BucketSettings;
import com.aw.dpa.test.functional.aws.s3.S3BucketSpecs;
import com.aw.dpa.test.functional.aws.s3.S3HealthHelper;
import com.aw.dpa.test.functional.aws.sqs.SqsHealthHelper;
 ...
 * and have the correct {@code InternalContainerServiceConfig} set for their respective {@link com.aw.dpa.test.LocalServiceEndpoint}s.
 ...
 * Extending AbstractFunctionalTests configures {@link com.aw.dpa.test.SharedConfig} with autoconfigured test contexts to be loaded
