...
public class LocalAwsServicesAutoConfigurationConditionMatchTest extends AbstractFullContextTest {
    ...
    public void beanConditionsMatch() {
        ...
        assertThat("DynamoDbResourceCreator has NOT been created - unexpected.", this.context.getBeansOfType(
              DynamoDbResourceCreator.class).size() == 1);
        ...
        assertThat("SQSResourceCreator has NOT been created - unexpected", this.context.getBeansOfType(
              SqsResourceCreator.class).size() == 1);
