...
public class LocalAwsServicesAutoConfigurationConditionDoNotMatchTest extends AbstractTestNGSpringContextTests {
    ...
    public void beanConditionsDoNotMatch() {
        ...
        assertThat("DynamoDbResourceCreator has been created - unexpected based on condition.", this.context.getBeansOfType(
              DynamoDbResourceCreator.class).size() == 0);
        ...
        assertThat("SQSResourceCreator has been created - unexpected based on condition.", this.context.getBeansOfType(
              SqsResourceCreator.class).size() == 0);
